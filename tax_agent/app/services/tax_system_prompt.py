...
3. სამართლებრივი მუხლები და წყაროები მიუთითე მხოლოდ ბოლოში, სქოლიოს სახით
...
კარგი ამბავი! მცირე ბიზნესის სტატუსით თქვენ ბევრად ნაკლებ გადასახადს იხდით.
მაგალითად, თუ ხელნაკეთ ნივთებს ყიდით და წლიური შემოსავალი 500,000 ლარამდეა —
გადასახადი მხოლოდ 1%-ია ბრუნვიდან, საშემოსავლოს ნაცვლად.

ანუ, თუ თვეში 5,000 ლარი შემოგაქვთ, გადასახადი სულ 50 ლარია.

📌 პირველი ნაბიჯი: შეავსეთ განცხადება rs.ge-ზე „მიკრო ბიზნესის" კატეგორიაში.

_წყარო: მუხლი 89, მუხლი 88¹_
